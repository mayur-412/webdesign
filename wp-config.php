<?php
/** WordPress configuration for Render + Aiven MySQL. */
...
elseif ( ! empty($_SERVER['HTTP_X_FORWARDED_PROTO']) && $_SERVER['HTTP_X_FORWARDED_PROTO'] === 'https' ) $_SERVER['SERVER_PORT'] = '443';
